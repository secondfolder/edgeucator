...
<section class="page">
	<NestedPageHeader
		...
		backText="Rewards"
		title={`Edit a reward for ${data.partner.name}`}
		description="Use the same reward form here that creates a new partnership reward, but with the current values prefilled."
	/>
