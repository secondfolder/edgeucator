...
Experimental [Helpers](https://webawesome.com/docs/components/?category=helpers) [Since 3.10](https://webawesome.com/docs/resources/changelog#wa_3100)
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.12.0/components/random-content/random-content.js';
```
